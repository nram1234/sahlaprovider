class Get_Future_Orders_json {
  String message;
  int errNum;
  bool status;
  Result result;

  Get_Future_Orders_json({this.message, this.errNum, this.status, this.result});

  Get_Future_Orders_json.fromJson(Map<String, dynamic> json) {
...
class AllOrders {
  ...
  AllOrders.fromJson(Map<String, dynamic> json) {
    ...
    timeExecutionRequest = json['time_execution_request'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['time_execution_request'] = this.timeExecutionRequest;
