...
class _ProfileeState extends State<Profilee> {
  ...
  getdatafromwep(){
    _allNetworking
        .preparation_doc_profile(token_id: box.read('token')).then((value) {
  ...
  mainImg=value.result.serviceDetails[0].mainImg;
      ...
      if (value.result.serviceDetails[0].lag.trim().isEmpty) {
        ...
        _kGooglePlex = CameraPosition(
          target:
          LatLng(double.parse(value.result.serviceDetails[0].lat), double.parse(value.result.serviceDetails[0].lag)),
          zoom: 15,
        );
      }
              ...
              child: Column(
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: _image == null && mainImg.trim().isEmpty
                        ? Row(
                      mainAxisAlignment:
