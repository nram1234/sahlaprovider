      ...
      child: Scaffold(
        ...
        body: StreamBuilder<Get_list_reservation_json>(
            stream: _allNetworking
                .get_list_reservation(token_id: token)
                .asStream(),
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: snapshot.data.result
                                      .allReservation[pos].view == "0" ? Colors
                                      .blueAccent.withOpacity(0.5):Colors.red.withOpacity(0.5),
                                  spreadRadius: 5,
                                  blurRadius: 7,
                                  offset: Offset(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  height: 3,
                                  color:snapshot.data.result
                                      .allReservation[pos].view == "0" ? Colors.blue:Colors.red,
                                  child: Row(
                                    mainAxisAlignment:
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(
                                          left: 16, right: 16),
                                      child: Text( snapshot.data.result.allReservation[pos].fromHrs ),
                                    ),
                                  ],
                                ),
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(
                                          left: 16, right: 16),
                                      child: Text( snapshot.data.result.allReservation[pos].toHrs),
                                    ),
                                  ],
                                ),
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(
                                          left: 16, right: 16),
                                      child: Text(snapshot.data.result.allReservation[pos].reservationDay),
                                    ),
                                  ],
                                ),
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(
                                          left: 16, right: 16),
                                      child: Text(snapshot.data.result.allReservation[pos].fullname),
                                    ),
                                  ],
                                ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(child: Text(snapshot.data.result.allReservation[pos].address)),
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text(snapshot.data.result.allReservation[pos].userMakeReservationName),
                                    ),
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(
                                          left: 16, right: 16),
                                      child: Text(snapshot.data.result.allReservation[pos].phone),
                                    ),
                                  ],
                                ),
