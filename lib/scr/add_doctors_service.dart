...
class Add_Doctors_Service extends StatefulWidget {
  BuildContext mycontext;

  Add_Doctors_Service(this.mycontext);

  @override
  _Add_Doctors_ServiceState createState() => _Add_Doctors_ServiceState();
}

class _Add_Doctors_ServiceState extends State<Add_Doctors_Service> {
